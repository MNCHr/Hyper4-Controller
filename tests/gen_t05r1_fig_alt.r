...
# Load data
t05_data <- read.table("t05r1.dat",header=TRUE,sep=",")
t05p95_data <- read.table("t05r1p95.dat",header=TRUE,sep=",")

# Define colors
plot_colors <- c("black","red")

# Start pdf driver
pdf(file="t05r1.pdf", height=3.5, width=8)
...
# Plot
plot(t05_data, type="p", pch=".", col=plot_colors[1], xlim=c(min_x, max_x), ylim=c(0, 10), ann=FALSE)
