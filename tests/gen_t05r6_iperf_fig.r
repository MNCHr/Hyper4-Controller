...
# Load data
t05_data <- read.table("t05r6iperf.dat",header=FALSE,sep="")

# Define colors
#plot_colors <- c("black","red")

# Start pdf driver
pdf(file="t05r6.pdf", height=3.5, width=8)
...
# routers removed
abline(v=end-adj,col="forestgreen",lty=3)
draw.circle(x=xpos-adj,y=25,radius=1,lty=1,lwd=1)
text(x=xpos-adj, y=25, labels = l)
